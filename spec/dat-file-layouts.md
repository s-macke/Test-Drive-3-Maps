...
| `0x00AD2` | `0x0E9E` | THEME.MUS    |         | 6th item loaded (not Image)                                  |
...
| `0x18FC2` | `0x0112` | COMPASS.LZ   | Image   | Unknown (1216 pixels, resolution unknown)                    |
| `0x190D5` | `0x0373` | CHASE.LZ     | Image   | Camera view arrows 64×248                                    |
| `0x19449` | `0x12D1` | WATER.LZ     | Image   | Unknown (15360 pixels, resolution unknown)                   |
| `0x1A71B` | `0x0F3D` | WATEREGA.LZ  | Image   | Unknown (15360 pixels, resolution unknown)                   |
...
| `0x08F33 - 0x0A4D0`   | `0x159D` | NEWWAVE.MUS  |         | Unknown                                         |
...
| `0x1ED2C - 0x21602`   | `0x28D6` | SCENETT1.DAT |         | Something for maps/tiles                        |
