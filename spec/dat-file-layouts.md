...
| `0x1E5A2`             | `0x1C09` |          |         | Unknown                                  |
| `0x201AC`             | `0x13B8` |          |         | Unknown                                  |
...
| `0x23818`             | `0x2171` |          |         | Unknown                                  |
| `0x2598A`             | `0x08E8` |          |         | Unknown                                  |
...
| `0x2A649`             | `0x2318` |          |         | Unknown                                  |
| `0x2C962`             | `0x0F19` |          |         | Unknown                                  |
| `0x2D87C`             | `0x2137` |          | Map     | Fifth map                                |
| `0x2F9B4`             | `0x0150` |          | Palette | 112-color palette                        |
| `0x2FB05`             | `0x27DA` |          |         | Unknown                                  |
| `0x322E0`             | `0x0F6A` |          |         | Unknown                                  |
...
| `0x00151` | `0x0980` |          |         | 7th item loaded                          |
| `0x00AD2` | `0x0E9E` |          |         | 6th item loaded                          |
| `0x01971` | `0x0150` |          | Palette | Intro, 112-color palette                 |
| `0x01AC2` | `0x2CE7` |          | LZW+RLE | Intro                                    |
| `0x047AA` | `0x2556` |          | LZW+RLE | Intro                                    |
| `0x06D01` | `0x25AC` |          | LZW+RLE | Intro                                    |
| `0x092AE` | `0x08C2` |          | LZW+RLE | Intro title                              |
| `0x09B71` | `0x3BE5` |          | LZW+RLE | Intro                                    |
| `0x0D757` | `0x14A7` |          | LZW+RLE | Intro title                              |
| `0x0EBFF` | `0x0150` |          | Palette | Intro, 112-color palette                 |
| `0x0ED50` | `0x0150` |          | Palette | Intro credits                            |
| `0x0EEA1` | `0x33D9` |          | LZW+RLE | Intro credits                            |
| `0x1227B` | `0x38F7` |          | LZW+RLE | Intro credits                            |
| `0x15B73` | `0x344E` |          | LZW+RLE | Intro credits                            |
| `0x18FC2` | `0x0112` |          |         | 1st item loaded                          |
| `0x190D5` | `0x0373` |          |         | 3rd item loaded                          |
| `0x19449` | `0x12D1` |          |         | 2nd item loaded                          |
| `0x1A71B` | `0x0F3D` |          |         | Unknown                                  |
| `0x1B659` | `0x1CFF` |          |         | 4th item loaded                          |
| `0x1D359` | `0x136C` |          |         | Unknown                                  |
...
| `0x0A4D1 - 0x0B8BC`   | `0x13EB` |            | LZW+RLE | Background image of menu                 |
| `0x0B8BD - 0x0EDAC`   | `0x34EF` |            | LZW+RLE | Loaded when menu is loaded               |
| `0x0EDAD - 0x121BE`   | `0x3411` |            | LZW+RLE | Skill driver option image                |
| `0x121BF - 0x15413`   | `0x3254` |            | LZW+RLE | Skill driver option image                |
| `0x15414 - 0x15514`   | `0x0100` |            |         | Unknown                                  |
| `0x15515 - 0x1ED2B`   | `0x0150` |            | Palette | 112-color palette                        |
| `0x15666`             | `0x31E2` |            |         | Unknown                                  |
| `0x18849`             | `0x3535` |            |         | Unknown                                  |
| `0x1BD7F`             | `0x2FAC` |            |         | Unknown                                  |
...
| Offset    | Size     | Filename | Format  | Description                              |
|-----------|----------|----------|---------|------------------------------------------|
| `0x00000` | `0x0150` |          | Palette | 112-color palette                        |
| `0x00151` | `0x0150` |          | Palette | 112-color palette                        |
| `0x002A2` | `0x00F7` |          |         | Unknown                                  |
| `0x0039A` | `0x00FA` |          |         | Unknown                                  |
| `0x00495` | `0x0150` |          | Palette | 112-color palette                        |
| `0x005E6` | `0x0112` |          |         | Unknown                                  |
